...
def normalize_dataframe(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # corregido
    new_df = new_df[new_df["email"].astype(str).str.strip() != ""]
...
if "asunto_global" not in st.session_state:
    st.session_state.asunto_global = ""
if "mensaje_global" not in st.session_state:
